...
export default props => {
   ...
   return (
      <form className="relative z-10 w-5/6 pb-8 mx-auto my-8 overflow-hidden bg-white shadow-xl md:w-2/3 lg:w-1/3">
         ...
         <div className="flex">
            ...
            >
               <svg viewBox="0 0 17 16" className="mx-auto transform scale-50">
                  <path
         ...
         >
            <svg className="transform scale-50" viewBox="0 0 511.993 511.993">
               <path
