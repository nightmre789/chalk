...
export default props => {
   return (
      <div className="px-5 py-3 bg-white border-b cursor-pointer message-item drop-shadow-md hover:drop-shadow-lg hover:border-t-0 border-slate-100 hover:border hover:z-10">
